...
export function createAppAliases(
  ...
  if (environmentCondition === 'browser') {
    if (reactConditon === 'server') {
      throw new Error(
        'React Server is not supported in browser builds. This is a bug in Next.js.'
      )
    }
    // prettier-ignore
    reactAlias = {
    ...
    reactAlias = {
      ...
      'react/jsx-dev-runtime$':                /* ✅ */ `next/dist/server/route-modules/app-page/vendored/rsc/jsx-dev-runtime`,
      'react/compiler-runtime$':               /* ✅ */ `next/dist/server/route-modules/app-page/vendored/rsc/compiler-runtime`,
      // file:///./../compiled/react-dom/package.json
    ...
    reactAlias[`next/dist/compiled/react${bundledReactChannel}$`] =
      reactAlias.react$
    reactAlias[`next/dist/compiled/react${bundledReactChannel}/jsx-runtime$`] =
      reactAlias[`react/jsx-runtime$`]
    reactAlias[
      `next/dist/compiled/react${bundledReactChannel}/jsx-dev-runtime$`
    ] = reactAlias[`react/jsx-dev-runtime$`]
    reactAlias[
      `next/dist/compiled/react${bundledReactChannel}/compiler-runtime$`
    ] = reactAlias[`react/compiler-runtime$`]
    reactAlias[`next/dist/compiled/react-dom${bundledReactChannel}$`] =
      reactAlias[`react-dom$`]
  } else {
    throw new Error(
